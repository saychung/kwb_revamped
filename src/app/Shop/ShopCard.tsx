...
const ShopCard = ({image} : {
    image : {
        ...
        
        {
            ...
            return(
                <div className="h-[85vh] lg:h-[70vh] w-[80vw] grid lg:grid-cols-2 place-content-center z-10 rounded-xl bg-[url(/nnnoise.svg)] overflow-hidden ">
                    ...
                    <div id="showScroll"  className="w-full h-full row-span-1 col-span-0 lg:col-span-1 lg:row-span-0 text-black border-l-0 lg:border-l-2 border-black overflow-y-scroll pb-10">
                        <h1 className="text-[20px] mx-10 border-b-2 border-black w-fit">{img.name}</h1>
                        <br/>
