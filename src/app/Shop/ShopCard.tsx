...
const ShopCard = ({image} : {
    image : {
        ...
        
        {
            ...
            return(
                <div className="h-[76svh] w-[80vw] p-2 grid sm:grid-cols-2 place-content-center rounded-xl overflow-hidden ">
                    <div className="row-span-1 col-span-0 sm:col-span-1 sm:row-span-0 w-full h-fit grid place-content-center p-6 border-b-2 sm:border-b-0 border-black">
                    ...
                    <div id="showScroll"  className="w-full p-2 h-full row-span-1 col-span-0 sm:col-span-1 sm:row-span-0 border-l-0 sm:border-l-2 border-black overflow-y-scroll pb-10">
