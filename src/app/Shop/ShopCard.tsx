        ...
        
        {
            ...
            return(
                <div className="backdrop-blur-sm h-fit max-w-[90vw] md:max-w-[80vw] lg:max-w-[70vw] m-2 p-1 grid sm:grid-cols-2 place-content-center border-[1px] border-orange-300 rounded-xl">
                    <div className="row-span-1 col-span-0 sm:col-span-1 sm:row-span-0 w-full h-fit grid place-content-center p-2 border-b-2 sm:border-b-0 border-orange-300">
                    ...
                    <div className="w-full p-2 h-full row-span-1 col-span-0 sm:col-span-1 sm:row-span-0 border-l-0 sm:border-l-2 border-orange-300 grid place-content-center">
                        <div>
