        ...
        {navLinks.map((link) => (
          <li key={link.href}>
            <Link href={link.href} className={`${
                ...
                currRoute === link.href ?  "text-orange-500 underline underline-offset-8 text-bold lg:rounded-t-md" : "text-black hover:text-green-500 rounded-md hover:animate-pulse duration-50 ease-in-out"
